...
//   const FromInpBoxAddAndHide = (city, airport) => {
//     setDepartureairportName(airport);
//     setDepartureCityName(city);
//     setsearchFrom(city);
//     SetinpBox("");
//   };
...
//   const ToInpBoxAddAndHide = (city, destination) => {
//     setdestinationAirportName(destination);
//     setdestinationCityName(city);
//     setsearchTo(city);
//     SetinpBox("");
//   };
...
//           <div>
//             {FlightData.length > 0 &&
//               FlightData[0].airport &&
//               FlightData[0].airport.map((airport) => (
//                 <div
...
//                         type="text"
//                         onChange={(e) =>
//                           handleChangeFrom(e.target.value || DepartureCityName)
//                         }
//                       />
...
//                             <p
//                               onClick={(e) =>
//                                 FromInpBoxAddAndHide(airport.city, airport.name)
//                               }
//                               key={index}
//                             >
//                               {airport.city}
...
//           {FlightData.length > 0 &&
//             FlightData[0].destination &&
//             FlightData[0].destination.map((destination) => (
//               <div
